...
syn keyword tmuxOptsSet message-bg message-command-bg lock-after-time default-path
syn keyword tmuxOptsSet message-attr message-command-attr status-attr set-remain-on-exit
